...
class DataEntryScreen:
    ...
    def _create_data_entry_screen(self):    
        ...
        self.data_entry_panel = tk.PanedWindow(self.main_window, orient=tk.VERTICAL, bg='#E9E6DB')
        self.data_entry_panel.pack(fill=tk.BOTH, expand=True)

        # Widget Frame per il nome
        name_frame = tk.Frame(self.data_entry_panel, bg='#E9E6DB')
        ...
        surname_frame = tk.Frame(self.data_entry_panel, bg='#E9E6DB')
        ...
        duration_frame = tk.Frame(self.data_entry_panel, bg='#E9E6DB')
        ...
        button_frame = tk.Frame(self.data_entry_panel, bg='#E9E6DB')
        button_frame.pack(side=tk.BOTTOM, fill=tk.X, pady=(10, 20))
        
        # Bottone per tornare indietro
        back_button = tk.Button(button_frame, text="Back", command= self._show_calibration_screen, font=("Arial", 18), bg='#E9E6DB', fg='black', padx=10, pady=5, highlightbackground='#E9E6DB')
        back_button.pack(side=tk.LEFT, padx=(20, 10), anchor='w')
        
        # Bottone per iniziare la misurazione
        next_button = tk.Button(button_frame, text="Start the Measurement ", command= self._show_data_acquisition_screen, font=("Arial", 18), bg='#E9E6DB', fg='black', padx=10, pady=5, highlightbackground='#E9E6DB')
